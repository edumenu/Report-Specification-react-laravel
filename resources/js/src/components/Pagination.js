    ...
    return (
        <nav aria-label="Page navigation example">
            <ul className="pagination justify-content-center">
                ...
                <li className={`page-item ${(comments.current_page + 1)  === comments.last_page ? "d-none" : ""}`}><a className="page-link" onClick={() => searchComments("pageSelect", (comments.current_page) + 1)}>{(comments.current_page) + 1}</a></li>
